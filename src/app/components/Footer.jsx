      ...
      <footer className="w-full">
        ...
        <div className="flex flex-col lg:flex-row relative overflow-hidden">
          ...
          <div className="w-full lg:w-[65%] bg-[#0F1724] px-6 py-12 md:py-24 lg:pl-32 lg:pr-12 relative">
            <div className="max-w-3xl">
              ...
              <div className="flex flex-col gap-10">
                <p className="text-white/70 text-sm md:text-base max-w-lg leading-relaxed">
                  I am here here to answer all your questions and provide you
                  with personalized advice.Don’t hesitate to get in touch with
                  me!
                </p>
            ...
            <div className="hidden lg:block absolute top-0 left-full h-full w-64 z-10 -ml-[1px]">
              <svg
                viewBox="0 0 100 100"
